...
class TBrickTest {
    ...
    @Test
    void tBrick_has_four_rotation_states() {
    ...
    void rotation_0_is_correct() {
        ...
        int[][] actualShape = tBrick.getShapeMatrix().get(0);
    ...
    void rotation_1_is_correct() {
        ...
        int[][] actualShape = tBrick.getShapeMatrix().get(1);
        assertArrayEquals(expectedShape, actualShape);
    }
    ...
    void rotation_2_is_correct() {
        ...
        int[][] actualShape = tBrick.getShapeMatrix().get(2);
        assertArrayEquals(expectedShape, actualShape);
    }
